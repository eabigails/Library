...
<div class="sidebar">
    ...
    <nav class="nav flex-column">
        <a class="nav-link active" href="<?= base_url('admin/dashboard') ?>"><i class="fa fa-tachometer-alt me-2"></i> Dashboard</a>
        ...
        <a class="nav-link text-danger mt-5" href="<?= base_url('auth/logout') ?>">
                ...
                <div class="card card-stat bg-primary p-4 shadow-sm">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0"><?= $stats['total_buku']; ?></h2>
                        </div>
                ...
                <div class="card card-stat bg-success p-4 shadow-sm">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0"><?= $stats['total_anggota']; ?></h2>
                        </div>
                ...
                <div class="card card-stat bg-warning p-4 shadow-sm text-dark">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h2 class="fw-bold mb-0"><?= $stats['total_pinjam']; ?></h2>
                        </div>
