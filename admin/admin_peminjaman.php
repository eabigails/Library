...
$query = "SELECT p.*, a.nama as nama_anggota, k.judul 
          FROM peminjaman p
...
<div class="sidebar">
    ...
    <nav class="nav flex-column">
        ...
        <a class="nav-link active" href="admin_peminjaman.php"><i class="fa fa-exchange-alt me-2"></i> Peminjaman</a>
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="../controllers/admin/admin_peminjaman_tambah.php" class="btn btn-primary"><i class="fa fa-plus me-2"></i>Tambah Manual</a>
    </div>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <?php if($row['status'] == 'Dipinjam') : ?>
                                <a href="../controllers/admin/admin_peminjaman_selesai.php?id=<?= $row['id_peminjaman'] ?>" 
